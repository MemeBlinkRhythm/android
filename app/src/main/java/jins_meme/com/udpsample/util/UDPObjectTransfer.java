package jins_meme.com.udpsample.util;
...
///
// http://qiita.com/niusounds/items/c02bee3001c2ff8056cf
public class UDPObjectTransfer {
     ...
     * @throws IOException
     */
    public static void send(byte[] sendData, String address, int port) throws IOException {
     ...
     */
    public static byte[] receive(int port, int bufferSize)
     ...
     * @throws ClassNotFoundException
     */
    public static byte[] receive(DatagramSocket clientSocket, int bufferSize)
            throws IOException, ClassNotFoundException {
